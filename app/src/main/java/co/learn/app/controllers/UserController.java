...
public class UserController {
    ...
    public User Login(@RequestBody User user) {
        ...
        // Retourner null si l'utilisateur n'existe pas ou si le mot de passe est incorrect
        return null;
    }
    ...
    public ResponseEntity<?> verifyResetCode(@RequestBody java.util.Map<String, String> payload) {
        ...
        if (ok) return ResponseEntity.ok(java.util.Map.of("message", "Code valide"));
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(java.util.Map.of("message", "Code invalide ou expiré"));
    }
    ...
    public ResponseEntity<?> confirmResetPassword(@RequestBody java.util.Map<String, String> payload) {
        ...
        if (ok) return ResponseEntity.ok(java.util.Map.of("message", "Mot de passe mis à jour"));
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(java.util.Map.of("message", "Code invalide ou expiré"));
    }
    ...
    public ResponseEntity<?> loginWithGoogle(@RequestBody Map<String, String> payload) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(java.util.Map.of("message", "Erreur OAuth Google: " + e.getMessage()));
        }
    }
}
